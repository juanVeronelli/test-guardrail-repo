...
const MODULE_ID = 'handler-003';
const DEFAULT_TIMEOUT_MS = 950;

function createHandler3(options = {}) {
...
async function demoHandler3() {
  const instance = createHandler3({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createHandler3, demoHandler3, MODULE_ID, DEFAULT_TIMEOUT_MS };
