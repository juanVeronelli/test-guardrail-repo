...
const MODULE_ID = 'handler-001';
const DEFAULT_TIMEOUT_MS = 850;

function createHandler1(options = {}) {
...
async function demoHandler1() {
  const instance = createHandler1({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createHandler1, demoHandler1, MODULE_ID, DEFAULT_TIMEOUT_MS };
