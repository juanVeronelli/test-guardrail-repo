...
const MODULE_ID = 'handler-018';
const DEFAULT_TIMEOUT_MS = 1700;

function createHandler18(options = {}) {
...
async function demoHandler18() {
  const instance = createHandler18({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createHandler18, demoHandler18, MODULE_ID, DEFAULT_TIMEOUT_MS };
