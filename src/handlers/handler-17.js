...
const MODULE_ID = 'handler-017';
const DEFAULT_TIMEOUT_MS = 1650;

function createHandler17(options = {}) {
...
async function demoHandler17() {
  const instance = createHandler17({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createHandler17, demoHandler17, MODULE_ID, DEFAULT_TIMEOUT_MS };
