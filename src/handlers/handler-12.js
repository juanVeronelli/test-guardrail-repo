...
const MODULE_ID = 'handler-012';
const DEFAULT_TIMEOUT_MS = 1400;

function createHandler12(options = {}) {
...
async function demoHandler12() {
  const instance = createHandler12({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createHandler12, demoHandler12, MODULE_ID, DEFAULT_TIMEOUT_MS };
