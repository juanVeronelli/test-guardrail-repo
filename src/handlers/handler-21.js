...
const MODULE_ID = 'handler-021';
const DEFAULT_TIMEOUT_MS = 850;

function createHandler21(options = {}) {
...
async function demoHandler21() {
  const instance = createHandler21({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createHandler21, demoHandler21, MODULE_ID, DEFAULT_TIMEOUT_MS };
