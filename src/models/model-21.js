...
const MODULE_ID = 'model-021';
const DEFAULT_TIMEOUT_MS = 850;

function createModel21(options = {}) {
...
async function demoModel21() {
  const instance = createModel21({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createModel21, demoModel21, MODULE_ID, DEFAULT_TIMEOUT_MS };
