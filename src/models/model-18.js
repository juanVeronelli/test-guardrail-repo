...
const MODULE_ID = 'model-018';
const DEFAULT_TIMEOUT_MS = 1700;

function createModel18(options = {}) {
...
async function demoModel18() {
  const instance = createModel18({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createModel18, demoModel18, MODULE_ID, DEFAULT_TIMEOUT_MS };
