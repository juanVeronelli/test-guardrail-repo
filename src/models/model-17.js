...
const MODULE_ID = 'model-017';
const DEFAULT_TIMEOUT_MS = 1650;

function createModel17(options = {}) {
...
async function demoModel17() {
  const instance = createModel17({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createModel17, demoModel17, MODULE_ID, DEFAULT_TIMEOUT_MS };
