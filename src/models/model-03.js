...
const MODULE_ID = 'model-003';
const DEFAULT_TIMEOUT_MS = 950;

function createModel3(options = {}) {
...
async function demoModel3() {
  const instance = createModel3({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createModel3, demoModel3, MODULE_ID, DEFAULT_TIMEOUT_MS };
