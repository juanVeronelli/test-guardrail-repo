...
const MODULE_ID = 'util-018';
const DEFAULT_TIMEOUT_MS = 1700;

function createUtil18(options = {}) {
...
async function demoUtil18() {
  const instance = createUtil18({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createUtil18, demoUtil18, MODULE_ID, DEFAULT_TIMEOUT_MS };
