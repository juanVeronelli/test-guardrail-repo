...
const MODULE_ID = 'util-021';
const DEFAULT_TIMEOUT_MS = 850;

function createUtil21(options = {}) {
...
async function demoUtil21() {
  const instance = createUtil21({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createUtil21, demoUtil21, MODULE_ID, DEFAULT_TIMEOUT_MS };
