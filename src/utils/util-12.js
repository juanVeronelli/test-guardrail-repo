...
const MODULE_ID = 'util-012';
const DEFAULT_TIMEOUT_MS = 1400;

function createUtil12(options = {}) {
...
async function demoUtil12() {
  const instance = createUtil12({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createUtil12, demoUtil12, MODULE_ID, DEFAULT_TIMEOUT_MS };
