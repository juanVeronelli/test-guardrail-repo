...
const MODULE_ID = 'util-017';
const DEFAULT_TIMEOUT_MS = 1650;

function createUtil17(options = {}) {
...
async function demoUtil17() {
  const instance = createUtil17({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createUtil17, demoUtil17, MODULE_ID, DEFAULT_TIMEOUT_MS };
