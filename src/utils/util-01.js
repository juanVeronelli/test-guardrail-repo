...
const MODULE_ID = 'util-001';
const DEFAULT_TIMEOUT_MS = 850;

function createUtil1(options = {}) {
...
async function demoUtil1() {
  const instance = createUtil1({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createUtil1, demoUtil1, MODULE_ID, DEFAULT_TIMEOUT_MS };
