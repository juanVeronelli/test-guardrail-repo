...
const MODULE_ID = 'util-003';
const DEFAULT_TIMEOUT_MS = 950;

function createUtil3(options = {}) {
...
async function demoUtil3() {
  const instance = createUtil3({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createUtil3, demoUtil3, MODULE_ID, DEFAULT_TIMEOUT_MS };
