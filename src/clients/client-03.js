...
async function demoClient3() {
  const instance = createClient3({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createClient3, demoClient3, MODULE_ID, DEFAULT_TIMEOUT_MS };
