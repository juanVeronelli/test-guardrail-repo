...
const MODULE_ID = 'client-018';
const DEFAULT_TIMEOUT_MS = 1700;

function createClient18(options = {}) {
...
async function demoClient18() {
  const instance = createClient18({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createClient18, demoClient18, MODULE_ID, DEFAULT_TIMEOUT_MS };
