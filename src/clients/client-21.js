...
const MODULE_ID = 'client-021';
const DEFAULT_TIMEOUT_MS = 850;

function createClient21(options = {}) {
...
async function demoClient21() {
  const instance = createClient21({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createClient21, demoClient21, MODULE_ID, DEFAULT_TIMEOUT_MS };
