...
const MODULE_ID = 'client-012';
const DEFAULT_TIMEOUT_MS = 1400;

function createClient12(options = {}) {
...
async function demoClient12() {
  const instance = createClient12({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createClient12, demoClient12, MODULE_ID, DEFAULT_TIMEOUT_MS };
