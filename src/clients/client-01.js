...
const MODULE_ID = 'client-001';
const DEFAULT_TIMEOUT_MS = 850;

function createClient1(options = {}) {
...
async function demoClient1() {
  const instance = createClient1({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createClient1, demoClient1, MODULE_ID, DEFAULT_TIMEOUT_MS };
