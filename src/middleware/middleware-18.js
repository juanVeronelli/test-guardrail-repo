...
const MODULE_ID = 'middleware-018';
const DEFAULT_TIMEOUT_MS = 1700;

function createMiddleware18(options = {}) {
...
async function demoMiddleware18() {
  const instance = createMiddleware18({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createMiddleware18, demoMiddleware18, MODULE_ID, DEFAULT_TIMEOUT_MS };
