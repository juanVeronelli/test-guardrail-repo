...
const MODULE_ID = 'middleware-001';
const DEFAULT_TIMEOUT_MS = 850;

function createMiddleware1(options = {}) {
...
async function demoMiddleware1() {
  const instance = createMiddleware1({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createMiddleware1, demoMiddleware1, MODULE_ID, DEFAULT_TIMEOUT_MS };
