...
const MODULE_ID = 'middleware-012';
const DEFAULT_TIMEOUT_MS = 1400;

function createMiddleware12(options = {}) {
...
async function demoMiddleware12() {
  const instance = createMiddleware12({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createMiddleware12, demoMiddleware12, MODULE_ID, DEFAULT_TIMEOUT_MS };
