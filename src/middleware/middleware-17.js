...
const MODULE_ID = 'middleware-017';
const DEFAULT_TIMEOUT_MS = 1650;

function createMiddleware17(options = {}) {
...
async function demoMiddleware17() {
  const instance = createMiddleware17({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createMiddleware17, demoMiddleware17, MODULE_ID, DEFAULT_TIMEOUT_MS };
