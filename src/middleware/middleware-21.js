...
const MODULE_ID = 'middleware-021';
const DEFAULT_TIMEOUT_MS = 850;

function createMiddleware21(options = {}) {
...
async function demoMiddleware21() {
  const instance = createMiddleware21({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createMiddleware21, demoMiddleware21, MODULE_ID, DEFAULT_TIMEOUT_MS };
