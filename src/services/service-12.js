...
const MODULE_ID = 'service-012';
const DEFAULT_TIMEOUT_MS = 1400;

function createService12(options = {}) {
...
async function demoService12() {
  const instance = createService12({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createService12, demoService12, MODULE_ID, DEFAULT_TIMEOUT_MS };
