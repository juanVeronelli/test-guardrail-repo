...
const MODULE_ID = 'service-001';
const DEFAULT_TIMEOUT_MS = 850;

function createService1(options = {}) {
...
async function demoService1() {
  const instance = createService1({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createService1, demoService1, MODULE_ID, DEFAULT_TIMEOUT_MS };
