...
const MODULE_ID = 'service-017';
const DEFAULT_TIMEOUT_MS = 1650;

function createService17(options = {}) {
...
async function demoService17() {
  const instance = createService17({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createService17, demoService17, MODULE_ID, DEFAULT_TIMEOUT_MS };
