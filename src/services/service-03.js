...
const MODULE_ID = 'service-003';
const DEFAULT_TIMEOUT_MS = 950;

function createService3(options = {}) {
...
async function demoService3() {
  const instance = createService3({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createService3, demoService3, MODULE_ID, DEFAULT_TIMEOUT_MS };
