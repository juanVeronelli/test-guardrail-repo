...
const MODULE_ID = 'service-018';
const DEFAULT_TIMEOUT_MS = 1700;

function createService18(options = {}) {
...
async function demoService18() {
  const instance = createService18({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createService18, demoService18, MODULE_ID, DEFAULT_TIMEOUT_MS };
