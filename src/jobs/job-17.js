...
const MODULE_ID = 'job-017';
const DEFAULT_TIMEOUT_MS = 1650;

function createJob17(options = {}) {
...
async function demoJob17() {
  const instance = createJob17({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createJob17, demoJob17, MODULE_ID, DEFAULT_TIMEOUT_MS };
