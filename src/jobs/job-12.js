...
const MODULE_ID = 'job-012';
const DEFAULT_TIMEOUT_MS = 1400;

function createJob12(options = {}) {
...
async function demoJob12() {
  const instance = createJob12({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createJob12, demoJob12, MODULE_ID, DEFAULT_TIMEOUT_MS };
