...
const MODULE_ID = 'job-003';
const DEFAULT_TIMEOUT_MS = 950;

function createJob3(options = {}) {
...
async function demoJob3() {
  const instance = createJob3({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createJob3, demoJob3, MODULE_ID, DEFAULT_TIMEOUT_MS };
