...
const MODULE_ID = 'job-001';
const DEFAULT_TIMEOUT_MS = 850;

function createJob1(options = {}) {
...
async function demoJob1() {
  const instance = createJob1({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createJob1, demoJob1, MODULE_ID, DEFAULT_TIMEOUT_MS };
