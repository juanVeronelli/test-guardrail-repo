...
const MODULE_ID = 'job-021';
const DEFAULT_TIMEOUT_MS = 850;

function createJob21(options = {}) {
...
async function demoJob21() {
  const instance = createJob21({ timeoutMs: DEFAULT_TIMEOUT_MS });
  const samples = [
...
module.exports = { createJob21, demoJob21, MODULE_ID, DEFAULT_TIMEOUT_MS };
