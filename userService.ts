...
export function UserBadComponent() {
  ...
  // Las operaciones que requieren service role deben ejecutarse en el servidor
  // Usar un endpoint API en lugar de exponer credenciales sensibles
  const serviceRole = undefined; // Removido: nunca exponer secrets en el cliente
